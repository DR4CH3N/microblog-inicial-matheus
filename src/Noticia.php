...
final class Noticia {
    ...
    /* METODOS PARA A AREA PUBLICA DO SITE */
    ...
    public function listarTodas():array {
        $sql = "SELECT data, titulo, resumo, id 
        FROM noticias 
        ORDER BY data DESC";
    ...
    public function listarDetalhes():array {
        $sql = "SELECT noticias.id, noticias.titulo, noticias.imagem, noticias.data, noticias.texto, usuarios.nome 
        AS autor FROM noticias LEFT JOIN usuarios
        ON noticias.usuario_id = usuarios.id 
    ...
    public function listarPorCategoria():array {
        $sql = "SELECT noticias.id, noticias.titulo, noticias.data, noticias.resumo, usuarios.nome 
        AS autor, categorias.nome 
        AS categoria
        FROM noticias
    ...
    public function busca():array {
        $sql = "SELECT titulo, data, resumo, id 
        FROM noticias 
        WHERE titulo LIKE :termo OR 
        texto LIKE :termo OR
        resumo LIKE :termo 
        ORDER BY data DESC";
